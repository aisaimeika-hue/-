...
export const ORCHARDS: Orchard[] = [
  {
    slug: "okumoto",
    name: "奥本みかん園",
    catch: "太陽のような笑顔で出迎え。減農薬で育て、直売所には朝採り野菜も並ぶ。ゆるやかな坂を降りていった先にみかん園が広がります。",
    address: "三浦市南下浦町上宮田2103",
    phone: "046-888-0895",
    photo: "/images/orchard-okumoto.jpg",
    quote: "できる限り減農薬で育てたみかんです。食べた後の皮は、お風呂に入れたり、紅茶に入れたりして楽しむこともできます。お弁当を持ってきてピクニックをしたり……長時間過ごすお客様が多い農園です。併設の直売所では朝採りの野菜や、採りたてのみかんを並べてお待ちしています",
  },
  {
    slug: "yamasa",
    name: "ヤマサみかん園",
    catch: "リゾートホテル「マホロバマインズ三浦」目の前。三浦海岸駅からも近い立地。農家さんも、訪れた人も、笑顔がたえない素敵な農園です。",
    address: "三浦市南下浦町上宮田3377",
    phone: "080-5087-1583",
    photo: "/images/orchard-yamasa.jpg",
    quote: "駅からも、ホテルからも、とにかく近いみかん園です。酸味・甘み・香りと三拍子揃ったみかんをお楽しみください。お待ちしてます！",
  },
  {
    slug: "okayasu",
    name: "岡安みかん園",
    catch: "閑静な住宅街を抜けて、子供たちの笑い声響く公園の目の前にあるみかん園。大きな納屋を抜けると、広大なみかん園が広がります。くしゃっと笑うチャーミングなお父さんと、息子さんが育てた美味しいみかんを楽しめます。",
    address: "三浦市南下浦町上宮田925",
    phone: "046-888-0954",
    photo: "/images/orchard-okayasu.jpg",
    quote: "40年以上みかん作りをしています。11月には、採りたての野菜を併設の直売所で販売します。美味しい三浦のみかんと野菜を楽しんでいただけたらと思います",
  },
  {
    slug: "yoshida",
    name: "よしだみかん園",
    catch: "可愛い遊園地のような受付がお出迎え。農園入り口には十月桜が咲き、その先に広大なみかん園、さらにその先を京急が走り抜けます。電車好きにはたまらないロケーション。",
    address: "三浦市南下浦町上宮田1020",
    phone: "046-888-1102",
    photo: "/images/yoshida-booth.jpg",
    quote: "桜も、みかんも、電車も、海も……全部楽しめるみかん園です。みかん狩りはお客さんが楽しむためのものだから、木と木の間隔をあけたり、木が高くなりすぎないように配慮しています。思いっきり楽しんでいってくださいね",
  },
  {
    slug: "ishii",
    name: "石井みかん園",
